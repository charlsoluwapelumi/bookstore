        ...
        $(".wishlist-btn").on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $(".wishlist-btn").html("<i class='fas fa-heart'></i> Added to wishlist")
                    .addClass("btn-delete-wishlist").removeClass("wishlist-btn");
                    ref();
                }
            });
        ...
        $(".btn-delete-wishlist").on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $(".btn-delete-wishlist").html("<i class='fas fa-heart'></i> Add to wishlist")
                    .addClass("wishlist-btn").removeClass("btn-delete-wishlist");
                    ref();
                }
            });
        });
