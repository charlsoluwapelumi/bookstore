          ...
          <div class="card">
            ...
            <form class="card-body" method="POST" action="charge.php">
              ...
              <script
                ...
                class="stripe-button"
                data-key="pk_test_51PBfWQRsYLjWICCkO9CWRTwPnhKji7fmFLEwRbti8fcA5yV1EevXjwTxfRw68zI7mLbjAbStu0ujtVTNlhDhENPv00Fs36KJ0c"

                data-currency="usd"
                data-label="pay now">
              </script>
              <!-- <button type="submit" name="submit" class="btn btn-primary btn-lg btn-block" type="submit">Continue to checkout</button> -->
